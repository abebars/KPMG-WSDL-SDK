<?php
/**
 * File for KPMGWsdlClass to communicate with SOAP service
 * @package KPMG
 ...
 */
/**
 * KPMGWsdlClass to communicate with SOAP service
 * Documentation : Tax calculation service that calculates tax on batches of invoices.
 * @package KPMG
 * @author WsdlToPhp Team <contact@wsdltophp.com>
 * @version 20150429-01
 * @date 2018-07-24
 */
class KPMGWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
    /**
     ...
     * @var string
     */
    const VALUE_WSDL_URL = 'https://kpmg-uat.hostedtax.thomsonreuters.com/sabrix/services/taxcalculationservice/2011-09-01/taxcalculationservice?wsdl';
    /**
    ...
    /**
     * Constructor
     * @uses KPMGWsdlClass::setLastError()
     * @uses KPMGWsdlClass::initSoapClient()
     * @uses KPMGWsdlClass::initInternArrayToIterate()
     * @uses KPMGWsdlClass::_set()
    ...
    public static function __set_state(array $_array,$_className = __CLASS__)
    {
        if(class_exists($_className))
        {
            ...
            if(is_object($object) && is_subclass_of($object,'KPMGWsdlClass'))
            {
     ...
     * @uses KPMGClassMap::classMap()
     * @uses KPMGWsdlClass::getDefaultWsdlOptions()
     * @uses KPMGWsdlClass::getSoapClientClassName()
     * @uses KPMGWsdlClass::setSoapClient()
     * @param array $_wsdlOptions WSDL options
     * @return void
     */
    public function initSoapClient($_wsdlOptions)
    {
        if(class_exists('KPMGClassMap',true))
        {
            $wsdlOptions = array();
            $wsdlOptions['classmap'] = KPMGClassMap::classMap();
     ...
     * If a class is named as {KPMG}SoapClient, then this is the class that will be used.
    ...
    {
        if(class_exists('KPMGSoapClient') && is_subclass_of('KPMGSoapClient','SoapClient'))
            return 'KPMGSoapClient';
        else
            return 'SoapClient';
    }
    /**
     * Method returning all default options values
     * @uses KPMGWsdlClass::WSDL_CACHE_WSDL
     * @uses KPMGWsdlClass::WSDL_COMPRESSION
     * @uses KPMGWsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses KPMGWsdlClass::WSDL_ENCODING
     * @uses KPMGWsdlClass::WSDL_EXCEPTIONS
     * @uses KPMGWsdlClass::WSDL_FEATURES
     * @uses KPMGWsdlClass::WSDL_LOGIN
     * @uses KPMGWsdlClass::WSDL_PASSWORD
     * @uses KPMGWsdlClass::WSDL_SOAP_VERSION
     * @uses KPMGWsdlClass::WSDL_STREAM_CONTEXT
     * @uses KPMGWsdlClass::WSDL_TRACE
     * @uses KPMGWsdlClass::WSDL_TYPEMAP
     * @uses KPMGWsdlClass::WSDL_URL
     * @uses KPMGWsdlClass::VALUE_WSDL_URL
     * @uses KPMGWsdlClass::WSDL_USER_AGENT
     * @uses KPMGWsdlClass::WSDL_PROXY_HOST
     * @uses KPMGWsdlClass::WSDL_PROXY_PORT
     * @uses KPMGWsdlClass::WSDL_PROXY_LOGIN
     * @uses KPMGWsdlClass::WSDL_PROXY_PASSWORD
     * @uses KPMGWsdlClass::WSDL_LOCAL_CERT
     * @uses KPMGWsdlClass::WSDL_PASSPHRASE
     * @uses KPMGWsdlClass::WSDL_AUTHENTICATION
     * @uses KPMGWsdlClass::WSDL_SSL_METHOD
     ...
     * @uses KPMGWsdlClass::getSoapClient()
     * @uses KPMGWsdlClass::getFormatedXml()
     ...
     * @uses KPMGWsdlClass::getSoapClient()
     * @uses KPMGWsdlClass::convertStringHeadersToArray()
     ...
     * @uses KPMGWsdlClass::getInternArrayToIterate()
     * @uses KPMGWsdlClass::getInternArrayToIterateIsArray()
     * @return int
     */
     ...
     * @uses KPMGWsdlClass::getInternArrayToIterateOffset()
     * @uses KPMGWsdlClass::setInternArrayToIterateOffset()
     * @return int
     */
     ...
     * @uses KPMGWsdlClass::getInternArrayToIterateOffset()
     * @uses KPMGWsdlClass::offsetExists()
     * @return bool true|false
     */
     ...
     * @uses KPMGWsdlClass::getAttributeName()
     * @uses KPMGWsdlClass::__toString()
     * @uses KPMGWsdlClass::_set()
     * @uses KPMGWsdlClass::_get()
     * @uses KPMGWsdlClass::setInternArrayToIterate()
     * @uses KPMGWsdlClass::setInternArrayToIterateIsArray()
     * @uses KPMGWsdlClass::setInternArrayToIterateOffset()
